...
export default function Mgsis() {
  ...
  const [pindOptions, setpindOptions] = useState([...secondaryIndustry]);
  const [sindOptions, setsindOptions] = useState([]);
  const dispatch = useDispatch();
  const handleCalculateIcbr = () => {
    dispatch(changeValueGst({ value: sectionScore, type: "sis" }));
    console.log("value dispatched for sis");
  };
